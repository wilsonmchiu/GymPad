...
public class SundayDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sunday_delete);
    ...
    public void deleteData(){
        btnDeleteData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(temp > 0){
                    int deleteRow = MONWORKOUT.deleteSunData(editID.getText().toString());
                    if(deleteRow > 0){
                        Toast.makeText(SundayDelete.this, "Successfully Deleted The Data!", Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(SundayDelete.this, "Something went wrong :(.", Toast.LENGTH_LONG).show();
                    }
                }else{
                    Toast.makeText(SundayDelete.this, "You Must Enter An ID to Delete :(.", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
