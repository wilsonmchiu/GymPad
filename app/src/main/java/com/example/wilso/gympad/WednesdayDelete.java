...
public class WednesdayDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wednesday_delete);
    ...
    public void deleteData(){
        btnDeleteData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(temp > 0){
                    int deleteRow = MONWORKOUT.deleteWedData(editID.getText().toString());
                    if(deleteRow > 0){
                        Toast.makeText(WednesdayDelete.this, "Successfully Deleted The Data!", Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(WednesdayDelete.this, "Something went wrong :(.", Toast.LENGTH_LONG).show();
                    }
                }else{
                    Toast.makeText(WednesdayDelete.this, "You Must Enter An ID to Delete :(.", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
