...
public class MondayDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monday_delete);
    ...
    public void deleteData(){
        btnDeleteData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(temp > 0){
                    int deleteRow = MONWORKOUT.deleteMonData(editID.getText().toString());
                    if(deleteRow > 0){
                        Toast.makeText(MondayDelete.this, "Successfully Deleted The Data!", Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(MondayDelete.this, "Something went wrong :(.", Toast.LENGTH_LONG).show();
                    }
                }else{
                    Toast.makeText(MondayDelete.this, "You Must Enter An ID to Delete :(.", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
