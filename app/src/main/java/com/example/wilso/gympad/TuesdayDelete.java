...
public class TuesdayDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tuesday_delete);
    ...
    public void deleteData(){
        btnDeleteData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(temp > 0){
                    int deleteRow = MONWORKOUT.deleteTuesData(editID.getText().toString());
                    if(deleteRow > 0){
                        Toast.makeText(TuesdayDelete.this, "Successfully Deleted The Data!", Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(TuesdayDelete.this, "Something went wrong :(.", Toast.LENGTH_LONG).show();
                    }
                }else{
                    Toast.makeText(TuesdayDelete.this, "You Must Enter An ID to Delete :(.", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
